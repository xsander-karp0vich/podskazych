...
export interface SessionConfig {
  ...
  systemPrompt?: string
  /**
   * Материалы пользователя — готовый блок из текста прикреплённых файлов, дописывается к
   * системному промпту. Только сессии подсказок: второму агенту main его не передаёт.
   * Пусто и undefined — файлов нет.
   */
  context?: string
  /**
